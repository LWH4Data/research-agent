...
- `@Research Library 저장한 대화 목록을 보여줘.`
- `@Research Library 지난번 굴절률 보정 대화의 요약을 수정해줘.`
...
저장한 기록도 자연어로 관리합니다. 예를 들어 “저장한 대화 목록을 보여줘”,
“굴절률 보정 대화의 요약과 태그를 수정해줘”, “레이저 실험 대화 기록을
삭제해줘”라고 요청할 수 있습니다. 비슷한 기록이 여러 개일 때만 Codex가 어느
기록인지 묻습니다. 수정은 제목·요약·태그처럼 검색을 위한 정리 정보에만
적용되고, 저장된 원문과 범위는 바뀌지 않습니다. 삭제는 Research Agent 안의
해당 대화 기록만 영구적으로 지우며 실제 Codex 대화나 PDF에는 영향을 주지
않습니다. 현재 삭제 취소 기능은 없습니다.
